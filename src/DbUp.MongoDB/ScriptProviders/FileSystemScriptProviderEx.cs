...
namespace DbUp.MongoDB.ScriptProviders
{
    ...
    public class FileSystemScriptProviderEx : IScriptProvider
    {
        ...
        public FileSystemScriptProviderEx(string directoryPath):this(directoryPath, new FileSystemScriptOptions())
        {
        }
        ...
        public FileSystemScriptProviderEx(string directoryPath, Func<string, bool> filter) : 
        ...
        [Obsolete("Use the constructor with Options argument instead")]
        public FileSystemScriptProviderEx(string directoryPath, Encoding encoding) :
        ...
        ///<param name="encoding">The encoding.</param>
        [Obsolete("Use the constructor with Options argument instead")]
        public FileSystemScriptProviderEx(string directoryPath, Func<string, bool> filter, Encoding encoding) :
        ...
        public FileSystemScriptProviderEx(string directoryPath, FileSystemScriptOptions options)
        {
            if (options==null)
        ...
        {
            var files = Directory
                .GetFiles(directoryPath, "*", ShouldSearchSubDirectories())
                .AsEnumerable();
